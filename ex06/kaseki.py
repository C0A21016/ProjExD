...
class Object:
    ...
    def over(self,image,size,pos):
        self.over_img_sfc = pg.image.load(image)
        self.over_img_sfc = pg.transform.rotozoom(self.over_img_sfc,0,size)
        self.over_img_rct = self.over_img_sfc.get_rect()
        self.over_img_rct.center = pos
...
def main():
    ...
    obj.doriru("ex03/fig/doriruu.png", 0.4,(1450,90))
    obj.hanma("ex03/fig/hanmaa.png", 0.3,(1200,95))
    obj.over("ex03/fig/gameov.webp", 1,(800,450))
